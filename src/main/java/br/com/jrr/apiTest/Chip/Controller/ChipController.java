...
public class ChipController {
    ...
    @PostMapping("/sell")
    @RolesAllowed("CLIENT")
    public ResponseEntity<ResponseDTO> sellChip(@RequestBody SaleClientRequestDTO sale) {
        inventoryService.sellChip(sale);
        ResponseDTO response = new ResponseDTO(HttpStatus.OK, "sales order completed");
